...
****************************************************************************/
  ...
  *//**********************************************************************/
  typedef struct
  {
    ...
    tFrac32 f32IGain;  /**< Scailing coefficient for current I_frac, fractional format normalized to fit into (-\f$2^{31}\f$, \f$2^{31}\f$-1). */
    tFrac32 f32UGain;  /**< Scailing coefficient for voltage U_frac, fractional format normalized to fit into (-\f$2^{31}\f$, \f$2^{31}\f$-1). */
    tFrac32 f32WIGain; /**< Scailing coefficient for angular speed WI_frac, fractional format normalized to fit into (-\f$2^{31}\f$, \f$2^{31}\f$-1). */
    tFrac32 f32EGain;  /**< Scailing coefficient for back-EMF E_frac, fractional format normalized to fit into (-\f$2^{31}\f$, \f$2^{31}\f$-1). */
...
****************************************************************************/
  ...
  extern tFrac32 AMCLIB_BemfObsrvDQ_F32(const SWLIBS_2Syst_F32 *const pIAB, const SWLIBS_2Syst_F32 *const pUAB, tFrac32 f32Velocity, tFrac32 f32Phase, AMCLIB_BEMF_OBSRV_DQ_T_F32 *const pCtrl);
...
****************************************************************************/
  ...
  *//**********************************************************************/
  typedef struct
  {
    ...
    SWLIBS_2Syst_F32  pIObsrvIn_1L;  /**< Inputs of RL circuit at step k-1 - low word */
    SWLIBS_2Syst_F16  pIObsrvIn_1H;  /**< Inputs of RL circuit at step k-1 - high word */
    tFrac16 f16IGain;  /**< Scailing coefficient for current I_frac, fractional format normalized to fit into (-\f$2^{15}\f$, \f$2^{15}\f$-1). */
    tFrac16 f16UGain;  /**< Scailing coefficient for voltage U_frac, fractional format normalized to fit into (-\f$2^{15}\f$, \f$2^{15}\f$-1). */
    tFrac16 f16WIGain; /**< Scailing coefficient for angular speed WI_frac, fractional format normalized to fit into (-\f$2^{15}\f$, \f$2^{15}\f$-1). */
    tFrac16 f16EGain;  /**< Scailing coefficient for back-EMF E_frac, fractional format normalized to fit into (-\f$2^{15}\f$, \f$2^{15}\f$-1). */
    tS16 s16Shift;     /**< Common gain shift, integer format [-14, 14]. Function accuracy guaranteed only for range [-1, 1]. */
...
****************************************************************************/
  ...
  extern tFrac16 AMCLIB_BemfObsrvDQ_F16(const SWLIBS_2Syst_F16 *const pIAB, const SWLIBS_2Syst_F16 *const pUAB, tFrac16 f16Velocity, tFrac16 f16Phase, AMCLIB_BEMF_OBSRV_DQ_T_F16 *const pCtrl);
...
****************************************************************************/
  ...
  *//**********************************************************************/
  typedef struct
  {
    ...
    tFloat fltIGain;  /**< Scailing coefficient for current I, single precision floating point format. */
    tFloat fltUGain;  /**< Scailing coefficient for voltage U, single precision floating point format. */
    tFloat fltWIGain; /**< Scailing coefficient for angular speed WI, single precision floating point format. */
    tFloat fltEGain;  /**< Scailing coefficient for back-EMF E, single precision floating point format. */
...
****************************************************************************/
  ...
  extern tFloat AMCLIB_BemfObsrvDQ_FLT(const SWLIBS_2Syst_FLT *const pIAB, const SWLIBS_2Syst_FLT *const pUAB, tFloat fltVelocity, tFloat fltPhase, AMCLIB_BEMF_OBSRV_DQ_T_FLT *const pCtrl);
