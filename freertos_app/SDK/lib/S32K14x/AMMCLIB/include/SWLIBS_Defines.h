...
#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** 2*\f$\\f$Pi in single precision floating point format. */
#define FLOAT_2_PI          ((tFloat) 6.28318530717958)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** \f$\\f$Pi in single precision floating point format. */
#define FLOAT_PI            ((tFloat) 3.14159265358979)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** \f$\\f$Pi/2 in single precision floating point format. */
#define FLOAT_PI_DIVBY_2    ((tFloat) 1.57079632679490)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** Tan(\f$\\f$Pi/6) in single precision floating point format. */
#define FLOAT_TAN_PI_DIVBY_6   ((tFloat)0.577350269189626000)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** Tan(\f$\\f$Pi/12) in single precision floating point format. */
#define FLOAT_TAN_PI_DIVBY_12   ((tFloat)0.267949192431123000)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** \f$\\f$Pi/6 in single precision floating point format. */
#define FLOAT_PI_DIVBY_6   ((tFloat)0.523598775598299000)  
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** Double to single precision correction constant for \f$\\f$Pi, equal to (\f$\\f$Pi(Double) - \f$\\f$Pi(Single)). */
#define FLOAT_PI_SINGLE_CORRECTION ((tFloat)4.371139006309477e-08)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** Double to single precision correction constant for \f$\\f$Pi, equal to  (2*(\f$\\f$Pi(Double) - \f$\\f$Pi(Single)). */
#define FLOAT_PI_CORRECTION ((tFloat)8.742278012618954e-08)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** \f$\\f$Pi/4 in single precision floating point format. */
#define FLOAT_PI_DIVBY_4    ((tFloat) 0.7853981633974480)
#endif 

#if (SWLIBS_SUPPORT_FLT == SWLIBS_STD_ON)
/** Number four divided by \f$\\f$Pi in single precision floating point format. */
