...
****************************************************************************/
  ...
  *//**********************************************************************/
  typedef struct
  {
    tFrac32 f32ADCComp;  /**< A/D converter error compensation constant. Is setup by #AMCLIB_WindmillingInit_F32. */
    AMCLIB_TRACK_OBSRV_T_F32 pParamATO;  /**< PI controller and integrator parameters and state. Parameters must be configured before use. */
    GDFLIB_FILTER_MA_T_F32 pDetMA;  /**< PLL lock detector internal state. Do not change. */
    tU8 u8DetNoiseCnt;   /**< PLL lock detector internal state. Do not change. */
    tU8 u8DetSpin;       /**< PLL lock detector internal state. Do not change. */
    tU16 u16DetHystCnt;  /**< PLL lock detector internal state. Do not change. */
    tU16 u16DetStopCnt;  /**< PLL lock detector internal state. Do not change. */
...
****************************************************************************/
  ...
  *//**********************************************************************/
  typedef struct
  {
    tFrac16 f16ADCComp;  /**< A/D converter error compensation constant. Is setup by #AMCLIB_WindmillingInit_F16. */
    AMCLIB_TRACK_OBSRV_T_F16 pParamATO;  /**< PI controller and integrator parameters and state. Parameters must be configured before use. */
    GDFLIB_FILTER_MA_T_F16 pDetMA; /**< PLL lock detector internal state. Do not change. */
    tU8 u8DetNoiseCnt;   /**< PLL lock detector internal state. Do not change. */
    tU8 u8DetSpin;       /**< PLL lock detector internal state. Do not change. */
    tU16 u16DetHystCnt;  /**< PLL lock detector internal state. Do not change. */
    tU16 u16DetStopCnt;  /**< PLL lock detector internal state. Do not change. */
...
****************************************************************************/
  ...
  *//**********************************************************************/
  typedef struct
  {
    tFloat fltADCComp;   /**< A/D converter error compensation constant. Is setup by #AMCLIB_WindmillingInit_FLT. */
    AMCLIB_TRACK_OBSRV_T_FLT pParamATO;  /**< PI controller and integrator parameters and state. Parameters must be configured before use. */
    GDFLIB_FILTER_MA_T_FLT pDetMA;  /**< PLL lock detector internal state. Do not change. */
    tU8 u8DetNoiseCnt;   /**< PLL lock detector internal state. Do not change. */
    tU8 u8DetSpin;       /**< PLL lock detector internal state. Do not change. */
    tU16 u16DetHystCnt;  /**< PLL lock detector internal state. Do not change. */
    tU16 u16DetStopCnt;  /**< PLL lock detector internal state. Do not change. */
